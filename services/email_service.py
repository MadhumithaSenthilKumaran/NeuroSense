...
"""
try:
    from email_service import send_report_email, send_session_reminder  # noqa: F401
except Exception:
    ...
    def send_session_reminder(to_address, patient_name, session_number, scheduled_for):
        return False
